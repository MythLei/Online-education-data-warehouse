...
case $1 in
    ...
    ;;
    "all")
        load_data "ods_base_category_info_full" "ods_base_province_full" "ods_base_source_full" "ods_base_subject_info_full" "ods_chapter_info_full" "ods_test_exam_full" "ods_test_exam_question_inc" "ods_test_paper_full" "ods_test_paper_question_full" "ods_test_point_question_full" "ods_test_question_info_full" "ods_test_question_option_full" "ods_cart_info_inc" "ods_comment_info_inc" "ods_course_info_full" "ods_favor_info_inc" "ods_knowledge_point_full" "ods_order_detail_inc" "ods_order_info_inc" "ods_payment_info_inc" "ods_review_info_inc" "ods_user_chapter_process_inc" "ods_user_info_inc" "ods_video_info_full" "ods_vip_change_detail_inc" "ods_test_exam_inc"
 ;;
esac
